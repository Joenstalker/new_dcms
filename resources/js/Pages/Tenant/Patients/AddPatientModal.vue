...
watch(() => props.show, (newVal) => {
    if (newVal) {
        if (props.patient) {
            ...
            form.balance = props.patient.balance || 0;
...
<template>
    <dialog class="modal" :class="{ 'modal-open': show }">
        <div class="modal-box w-11/12 max-w-4xl p-0 overflow-hidden bg-base-200">
            <!-- Header -->
            ...
            <!-- Content Area -->
            <form @submit.prevent="submit" class="p-6 overflow-y-auto max-h-[70vh] custom-scrollbar space-y-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 border-t border-base-300 pt-4 mt-4">
                            ...
                            <div class="form-control sm:col-span-2 lg:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model.number="form.balance" type="number" step="0.01" min="0" class="input input-bordered w-full pl-8 rounded-xl bg-base-100" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Footer Actions -->
                <div class="bg-base-100 p-4 border-t border-base-300 flex justify-end gap-3 rounded-xl sticky bottom-0 mt-8 shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
