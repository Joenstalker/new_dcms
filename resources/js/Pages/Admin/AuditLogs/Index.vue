...
const actionBadgeClass = (action) => {
    ...
    if (action.includes('updated') || action.includes('synced')) return 'bg-blue-100 text-blue-800';
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500"
                        />
                    </div>
                    ...
                    <select
                        v-model="action"
                        @change="applyFilters"
                        class="block w-full py-2 px-3 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500"
                    >
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Target</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr v-if="!logs.data?.length">
                                <td colspan="6" class="px-6 py-12 text-center text-gray-400">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">Admin actions will be recorded here.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
