            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button
                        v-if="unread_count > 0"
                        @click="markAllAsRead"
                        class="inline-flex items-center px-4 py-2 bg-teal-600 rounded-lg text-sm font-medium text-white hover:bg-teal-700 transition-colors"
                    >
                        Mark All as Read
                    </button>
                </div>
        ...
        <div class="mb-6 border-b border-gray-200">
            <nav class="-mb-px flex space-x-8">
                <button
                    v-for="tab in tabs"
                    :key="tab.value"
                    @click="activeTab = tab.value; router.visit(route('admin.notifications.index', { read: tab.value }))"
                    :class="[
                        activeTab === tab.value
