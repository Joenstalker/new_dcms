            ...
            <div class="inline-block align-bottom bg-base-100 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full border border-base-300">
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-4 space-y-4">
                                <!-- Clinic Name -->
                                <div>
                                    <label for="tenant-name" class="block text-sm font-medium text-base-content/70">
                                        Clinic Name <span class="text-error">*</span>
                                    </label>
                                    <input
                                        id="tenant-name"
                                        :value="newTenantName"
                                        ...
                                        type="text"
                                        class="mt-1 block w-full border border-base-300 bg-base-100 text-base-content rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
                                ...
                                <!-- Domain/Subdomain -->
                                <div>
                                    <label for="tenant-domain" class="block text-sm font-medium text-base-content/70">
                                        Domain/Subdomain <span class="text-error">*</span>
                                    </label>
                                    <input
                                        id="tenant-domain"
                                ...
                                <div class="bg-base-200 rounded-lg p-4">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="text-sm font-medium text-base-content/70">Database Name Preview</span>
                                        <span v-if="isLoadingPreview" class="text-xs text-base-content/50">Loading...</span>
                                    </div>
                                    
                                    <div v-if="databasePreview" class="space-y-2">
                                        <div class="flex items-center">
                                            <svg class="h-5 w-5 text-base-content/30 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" />
                                            </svg>
                                            <code class="text-sm font-mono text-primary bg-base-100 px-2 py-1 rounded border border-base-300">
                                        ...
                                        <p v-if="databasePreview.already_exists" class="text-xs text-error flex items-center">
                                            <svg class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                                            </svg>
                                            This database name already exists
                                        </p>
                                        <p v-else class="text-xs text-success flex items-center">
                                            <svg class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-base-200 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse border-t border-base-300">
                    <button
                        ...
                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-primary-content hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        Create Clinic
                    </button>
                    <button
