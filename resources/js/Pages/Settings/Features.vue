            ...
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="space-y-8">
                    <div 
                        ...
                        :class="getCategoryStatusColor(getCategoryStatus(category))"
                    >
                        <!-- Category Header -->
                        <div class="px-6 py-4 border-b" :class="getCategoryStatus(category) === 'locked' ? 'border-gray-200' : ''">
                            <div class="flex items-center justify-between">
                                <div>
                                ...
                                <span 
                                    v-if="getCategoryStatus(category) === 'full'"
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800"
                                >
                                    All Available
                                </span>
                                <span 
                                    v-else-if="getCategoryStatus(category) === 'partial'"
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800"
                                >
                                    Some Available
                                </span>
                                <span 
                                    v-else-if="getCategoryStatus(category) === 'locked'"
                ...
                <!-- Upgrade CTA -->
                <div v-if="subscription" class="mt-8 bg-gray-50 rounded-lg border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-lg font-medium text-gray-900">Need more features?</h4>
