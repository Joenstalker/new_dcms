...
return new class extends Migration 
{
    /**
     * Run the migrations.
     * Creates permission tables in the central database for the central domain (lvh.me).
     */
    public function up(): void
    {
        ...
        Schema::create($tableNames['role_has_permissions'], static function (Blueprint $table) use ($tableNames, $columnNames, $pivotRole, $pivotPermission, $teams) {
            $table->unsignedBigInteger($pivotPermission);
            $table->unsignedBigInteger($pivotRole);
            ...
            if ($teams) {
                ...
                $table->primary([$columnNames['team_foreign_key'], $pivotPermission, $pivotRole],
