...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'central' => [
            'driver' => env('DB_CENTRAL_CONNECTION', 'mysql'),
            ...
            'strict' => true,
            'engine' => null,
            'timezone' => env('DB_CENTRAL_TIMEZONE', env('DB_TIMEZONE', '+00:00')),
            'foreign_key_constraints' => env('DB_CENTRAL_FOREIGN_KEYS', env('DB_FOREIGN_KEYS', true)),
            'busy_timeout' => null,
            'journal_mode' => null,
            'synchronous' => null,
            'transaction_mode' => 'DEFERRED',
